...
public:
    ...
    // You don't have to specify all rows; ECTextViewImp automatically fills the remaining rows
    ...
    // Get position of the cursor: x coordinate (horinzontal); position starts from 0
